...
public class ABMZona extends javax.swing.JInternalFrame {
    Conexion conexion;
    DefaultTableModel modelo;
    TableRowSorter sorter;
    OpcionCRUD opcionCRUD;
    ZonaCRUD zonaCRUD;
    ArrayList arrayOpcion, arrayZona;
    
    String empresa;
    int id_zona;
    
    public ABMZona(Conexion conexion, String empresa) {
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        ZonaData tmp = (ZonaData) arrayZona.get(indice);
        this.id_zona = tmp.getId_zona();
        this.jLblId_zona.setText(String.valueOf(tmp.getId_zona()));
