...
public class ABMTecnico extends javax.swing.JInternalFrame {
    Conexion conexion;
    DefaultTableModel modelo;
    TableRowSorter sorter;
    OpcionCRUD opcionCRUD;
    TecnicoCRUD tecnicoCRUD;
    ArrayList arrayOpcion, arrayTecnico;
    
    String empresa;
    int id_tecnico;
    
    public ABMTecnico(Conexion conexion, int id_empresa,String empresa) {
    ...
    private void initComponents() {
        ...
        jLblId_tecnico = new javax.swing.JLabel();
        ...
        setTitle("ABM Técnico de cirugía");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/bosoft/Bosoft.png"))); // NOI18N

        jLblId_tecnico.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLblId_tecnico.setText("---");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Salida", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(0, 0, 0)));
    ...
    private void consulta(){
        ...
        arrayTecnico = tecnicoCRUD.consulta(false);
        Iterator i = arrayTecnico.iterator();
        while (i.hasNext()){
            TecnicoData tmp = (TecnicoData) i.next();
            int id = tmp.getId_tecnico();
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        TecnicoData tmp = (TecnicoData) arrayTecnico.get(indice);
        this.id_tecnico = tmp.getId_tecnico();
        this.jLblId_tecnico.setText(String.valueOf(this.id_tecnico));
    ...
    private javax.swing.JLabel jLblId_tecnico;
