...
public class ABMPlazo extends javax.swing.JInternalFrame {
    Conexion conexion;
    DefaultTableModel modelo;
    TableRowSorter sorter;
    OpcionCRUD opcionCRUD;
    PlazoCRUD plazoCRUD;
    ArrayList arrayOpcion, arrayPlazo;
    
    String empresa;
    int id_plazo;
    
    public ABMPlazo(Conexion conexion, String empresa) {
    ...
    private void initComponents() {
        ...
        jLblId_plazo = new javax.swing.JLabel();
        ...
        setTitle("ABM Plazo de entrega");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/bosoft/Bosoft.png"))); // NOI18N

        jLblId_plazo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLblId_plazo.setText("---");
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        PlazoData tmp = (PlazoData) arrayPlazo.get(indice);
        this.id_plazo = tmp.getId_plazo();
        this.jLblId_plazo.setText(String.valueOf(this.id_plazo));
    ...
    private javax.swing.JLabel jLblId_plazo;
