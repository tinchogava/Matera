...
public class ABMClasiEntidad extends javax.swing.JInternalFrame {
    Conexion conexion;
    DefaultTableModel modelo;
    TableRowSorter sorter;
    OpcionCRUD opcionCRUD;
    ClasiEntidadCRUD clasiEntidadCRUD;
    ArrayList arrayOpcion, arrayClasiEntidad;
    
    String empresa;
    int id_clasiEntidad;
    
    public ABMClasiEntidad(Conexion conexion, String empresa) {
    ...
    private void initComponents() {
        ...
        jLblId_clasiEntidad = new javax.swing.JLabel();
        ...
        setTitle("ABM Clasificación de entidades");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/bosoft/Bosoft.png"))); // NOI18N

        jLblId_clasiEntidad.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLblId_clasiEntidad.setText("---");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLblId_clasiEntidad)
    ...
    private void limpia(){
        this.jLblId_clasiEntidad.setText("---");
    ...
    private void jBtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGuardarActionPerformed
        if (validaObligatorios()){
            ClasiEntidadData nuevo = new ClasiEntidadData();
            nuevo.setId_clasiEntidad(this.id_clasiEntidad);
            nuevo.setNombre(this.jTxtNombre.getText());
            nuevo.setHabilita(this.jComboHabilita.getSelectedItem().toString().substring(0, 1));
            
            clasiEntidadCRUD.insert(nuevo);
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        ClasiEntidadData tmp = (ClasiEntidadData) arrayClasiEntidad.get(indice);
        this.id_clasiEntidad = tmp.getId_clasiEntidad();
        this.jLblId_clasiEntidad.setText(String.valueOf(this.id_clasiEntidad));
    ...
    private javax.swing.JLabel jLblId_clasiEntidad;
