...
public class ABMFormaPago extends javax.swing.JInternalFrame {
    ...
    ArrayList arrayOpcion, arrayFormaPago;
    
    String empresa;
    int id_formaPago;
    
    public ABMFormaPago(Conexion conexion, String empresa) {
    ...
    private void initComponents() {
        ...
        jLblId_formaPago = new javax.swing.JLabel();
        ...
        setTitle("ABM Forma de pago");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/bosoft/Bosoft.png"))); // NOI18N

        jLblId_formaPago.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLblId_formaPago.setText("---");
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        FormaPagoData tmp = (FormaPagoData) arrayFormaPago.get(indice);
        this.id_formaPago = tmp.getId_formaPago();
        this.jLblId_formaPago.setText(String.valueOf(this.id_formaPago));
    ...
    private javax.swing.JLabel jLblId_formaPago;
