...
public class ABMClasiProducto extends javax.swing.JInternalFrame {
    Conexion conexion;
    DefaultTableModel modelo;
    TableRowSorter sorter;
    OpcionCRUD opcionCRUD;
    ClasiProductoCRUD clasiProductoCRUD;
    ArrayList arrayOpcion, arrayClasiProducto;
    
    String empresa;
    int id_clasiProducto;
    
    public ABMClasiProducto(Conexion conexion, String empresa) {
    ...
    private void initComponents() {
        ...
        jLblId_clasiProducto = new javax.swing.JLabel();
        ...
        setTitle("ABM Clasificación de productos");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/bosoft/Bosoft.png"))); // NOI18N

        jLblId_clasiProducto.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLblId_clasiProducto.setText("---");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLblId_clasiProducto)
    ...
    private void limpia(){
        this.jLblId_clasiProducto.setText("---");
    ...
    private void jBtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGuardarActionPerformed
        if (validaObligatorios()){
            ClasiProductoData nuevo = new ClasiProductoData();
            nuevo.setId_clasiProducto(this.id_clasiProducto);
            nuevo.setNombre(this.jTxtNombre.getText());
            nuevo.setHabilita(this.jComboHabilita.getSelectedItem().toString().substring(0, 1));
            
            clasiProductoCRUD.insert(nuevo);
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        ClasiProductoData tmp = (ClasiProductoData) arrayClasiProducto.get(indice);
        this.id_clasiProducto = tmp.getId_clasiProducto();
        this.jLblId_clasiProducto.setText(String.valueOf(this.id_clasiProducto));
    ...
    private javax.swing.JLabel jLblId_clasiProducto;
