...
public class ABMCodConsumo extends javax.swing.JInternalFrame {
    Conexion conexion;
    DefaultTableModel modelo;
    TableRowSorter sorter;
    OpcionCRUD opcionCRUD;
    CodConsumoCRUD codConsumoCRUD;
    ArrayList arrayOpcion, arrayCodConsumo;
    
    String empresa;
    int id_codConsumo;
    
    public ABMCodConsumo(Conexion conexion, String empresa) {
    ...
    private void initComponents() {
        ...
        setTitle("ABM Códigos de consumo");
    ...
    private void consulta(){
        ...
        arrayCodConsumo = codConsumoCRUD.consulta(false);
        Iterator i = arrayCodConsumo.iterator();
        while (i.hasNext()){
            CodConsumoData tmp = (CodConsumoData) i.next();
            String codigo = tmp.getCodigo();
            String nombre = tmp.getNombre();
            String habilitado = tmp.getHabilita().equals("S") ? "SI" : "NO";
            Object [] nuevo = {codigo,nombre,habilitado};
            modelo.addRow(nuevo);
        }
    }
    ...
    private boolean existeCodigo(){
        ...
        return Utiles.existeEnModelo(modelo, 0, codigo);
    }
    ...
    private void jBtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGuardarActionPerformed
        if (validaObligatorios()){
            if (!existeCodigo()){
                CodConsumoData nuevo = new CodConsumoData();
                nuevo.setId_codConsumo(this.id_codConsumo);
                ...
                codConsumoCRUD.insert(nuevo);
                
                CacheCodConsumo.instance().fetch();

                this.limpia();
                this.consulta();
                this.jTxtCodigo.requestFocus();
            }else{
                JOptionPane.showMessageDialog(this, "Ya existe ese código", "Atención", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        CodConsumoData tmp = (CodConsumoData) arrayCodConsumo.get(indice);
        this.id_codConsumo = tmp.getId_codConsumo();
