...
public class ABMSubespecialidad extends javax.swing.JInternalFrame {
    Conexion conexion;
    ...
    ArrayList arrayOpcion, arrayEspecialidad, arraySubespecialidad;
    
    String empresa;
    int id_subespecialidad;
    
    public ABMSubespecialidad(Conexion conexion, String empresa) {
    ...
    private void initComponents() {
        ...
        jLblId_zona = new javax.swing.JLabel();
        ...
        setTitle("ABM Subespecialidad");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/bosoft/Bosoft.png"))); // NOI18N

        jLblId_zona.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLblId_zona.setText("---");
    ...
    private void limpia(){
        this.jLblId_zona.setText("---");
        this.jComboEspecialidad.setSelectedIndex(arrayEspecialidad.isEmpty() ? -1 : 0);
    ...
    private boolean validaObligatorios(){
        return this.jComboEspecialidad.getSelectedIndex() >= 0 && 
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        SubespecialidadData tmp = (SubespecialidadData) arraySubespecialidad.get(indice);
        this.id_subespecialidad = tmp.getId_subespecialidad();
        this.jLblId_zona.setText(String.valueOf(tmp.getId_subespecialidad()));
    ...
    private javax.swing.JLabel jLblId_zona;
