...
public class ABMCaja extends javax.swing.JInternalFrame {
    Conexion conexion;
    DefaultTableModel modelo;
    TableRowSorter sorter;
    OpcionCRUD opcionCRUD;
    CajaCRUD cajaCRUD;
    ArrayList arrayOpcion, arrayCaja;
    
    String empresa;
    int id_caja;
    
    public ABMCaja(Conexion conexion, String empresa) {
    ...
    private void initComponents() {
        ...
        jLblId_caja = new javax.swing.JLabel();
        ...
        setTitle("ABM Caja de instrumental");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/bosoft/Bosoft.png"))); // NOI18N

        jLblId_caja.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLblId_caja.setText("---");
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        CajaData tmp = (CajaData) arrayCaja.get(indice);
        this.id_caja = tmp.getId_caja();
        this.jLblId_caja.setText(String.valueOf(this.id_caja));
    ...
    private javax.swing.JLabel jLblId_caja;
