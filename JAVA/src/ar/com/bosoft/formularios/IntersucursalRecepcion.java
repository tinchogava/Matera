 ...
 */
public class IntersucursalRecepcion extends javax.swing.JInternalFrame {
    Conexion conexion;
     ...
     * @param usuario
     */
    public IntersucursalRecepcion(Conexion conexion, int id_empresa, String empresa, String usuario) {
    ...
    private void secuencia(){
        ...
        if (respuesta == JOptionPane.YES_OPTION){
            SwingUtilities.invokeLater(new Runnable() {
                @Override
                public void run() {
                    IntersucursalRecepcion.this.avisoEspera = new AvisoEspera(null, false, 2);
                    IntersucursalRecepcion.this.avisoEspera.setVisible(true);
                    Thread performer = new Thread(new Runnable() {
                        @Override
                        public void run() {
                            IntersucursalRecepcion.this.insertRemitoDetalle();
                            IntersucursalRecepcion.this.recibeIntersucursal();
                            IntersucursalRecepcion.this.avisoEspera.setVisible(false);
                            IntersucursalRecepcion.this.limpia();
                        }
                    }, "Performer");
                    performer.start();
                }
    ...
    private void insertRemitoDetalle(){
        ...
        for (int i = 0; i < modeloProducto.getRowCount(); i++){
            ...
            int cantidad = Integer.parseInt(Utiles.valueAt(modeloProducto, i, "recibe").toString());
            if (cantidad > 0) {
                int id_producto = Integer.parseInt(modeloProducto.getValueAt(i, Utiles.getColumnByName(modeloProducto, "id_producto")).toString());
                String lote = modeloProducto.getValueAt(i, Utiles.getColumnByName(modeloProducto, "lote")).toString();
                String serie = modeloProducto.getValueAt(i, Utiles.getColumnByName(modeloProducto, "serie")).toString();
                String pm = modeloProducto.getValueAt(i, Utiles.getColumnByName(modeloProducto, "pm")).toString();
                try{
                    venc = formatter.parse(modeloProducto.getValueAt(i, Utiles.getColumnByName(modeloProducto, "vencimiento")).toString());
                }catch (Exception e){
                    //No se ha ingresado una fecha válida
                }
                Double costo = Double.parseDouble(modeloProducto.getValueAt(i, Utiles.getColumnByName(modeloProducto, "costo")).toString());
                int id_moneda = (int) modeloProducto.getValueAt(i, Utiles.getColumnByName(modeloProducto, "id_moneda"));
    ...
    private void imprime(int salida, boolean previa){
        ...
        while (itClasiProducto.hasNext()){
            ...
            for (int i = 0; i < modeloProducto.getRowCount(); i++){
                String codigo = Utiles.valueAt(modeloProducto, i, "codigo").toString();
                String gtin = Utiles.valueAt(modeloProducto, i, "gtin").toString();
                String nombre = Utiles.valueAt(modeloProducto, i, "nombre").toString();
                int cantidad = Integer.parseInt(Utiles.valueAt(modeloProducto, i, "envio").toString());
                String pm = Utiles.valueAt(modeloProducto, i, "pm").toString();
                String lote = Utiles.valueAt(modeloProducto, i, "lote").toString();
                String serie = Utiles.valueAt(modeloProducto, i, "serie").toString();
    ...
    private void initComponents() {
        ...
        jBtnAgregaProducto = new javax.swing.JButton();

        setTitle("Recepción intersucursal");
        ...
        jTablaProductos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
            };
            boolean[] canEdit = new boolean [] {
        ...
        jBtnAgregaProducto.setText("Agregar producto");
        jBtnAgregaProducto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtnAgregaProductoActionPerformed(evt);
            }
        });
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jBtnAgregaProducto)
    ...
    private void jBtnFiltraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnFiltraActionPerformed
        try {
            ...
            rsConsulta = conexion.procAlmacenado("consultaIntersucursalRecepcion", parametros, 
                            this.empresa, this.getClass().getName(), Thread.currentThread().getStackTrace()[1].toString());
    ...
    private void jBtnAgregaProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAgregaProductoActionPerformed
    ...
    }//GEN-LAST:event_jBtnAgregaProductoActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jBtnAgregaProducto;
