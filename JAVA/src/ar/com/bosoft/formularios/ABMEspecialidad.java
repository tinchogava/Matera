...
public class ABMEspecialidad extends javax.swing.JInternalFrame {
    ...
    ArrayList arrayOpcion, arrayEspecialidad;
    
    String empresa;
    int id_especialidad;
    
    public ABMEspecialidad(Conexion conexion, String empresa) {
    ...
    private void jBtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGuardarActionPerformed
        if (validaObligatorios()){
            EspecialidadData nuevo = new EspecialidadData();
            nuevo.setId_especialidad(this.id_especialidad);
            nuevo.setNombre(this.jTxtNombre.getText());
            nuevo.setHabilita(this.jComboHabilita.getSelectedItem().toString().substring(0, 1));
            
            especialidadCRUD.insert(nuevo);
    ...
    private void jTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaMouseClicked
        ...
        EspecialidadData tmp = (EspecialidadData) arrayEspecialidad.get(indice);
        this.id_especialidad = tmp.getId_especialidad();
        this.jLblId_zona.setText(String.valueOf(this.id_especialidad));
