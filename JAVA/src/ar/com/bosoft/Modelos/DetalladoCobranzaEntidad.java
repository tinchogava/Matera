 ...
 */
public class DetalladoCobranzaEntidad {
    Date fechaRecibo, fechaFactura;
    String entidad, numRecibo, numFactura, tipoOperacion;
    int id_presupuesto;
    BigDecimal importeAplicado, rm1, rm2;

    public DetalladoCobranzaEntidad(Date fechaRecibo, Date fechaFactura, String entidad, String numRecibo, String numFactura, String tipoOperacion, int id_presupuesto, BigDecimal importeAplicado, BigDecimal rm1, BigDecimal rm2) {
