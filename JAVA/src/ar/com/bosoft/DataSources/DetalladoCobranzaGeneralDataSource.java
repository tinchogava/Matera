 ...
 */
public class DetalladoCobranzaGeneralDataSource implements JRDataSource {
    private final List<DetalladoCobranzaGeneral> lista = new ArrayList<>();
    private int indiceActual = -1;
    
    public void add(DetalladoCobranzaGeneral nuevo){
