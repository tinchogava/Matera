 ...
 */
public class PlazosCobranzaGeneralDataSource implements JRDataSource {
    private final List<PlazosCobranzaGeneral> lista = new ArrayList<>();
    private int indiceActual = -1;
    
    public void add(PlazosCobranzaGeneral nuevo){
