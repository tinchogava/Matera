...
public class Mapaconfirmaturno extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 558687953;

	/**
	 * The parameter <code>matera.mapaConfirmaTurno.id_empresa</code>.
	 */
	 ...
	 */
	public Mapaconfirmaturno() {
		super("mapaConfirmaTurno", Matera.MATERA);
