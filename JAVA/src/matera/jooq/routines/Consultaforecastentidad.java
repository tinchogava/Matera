...
public class Consultaforecastentidad extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -164626805;

	/**
	 * The parameter <code>matera.consultaForecastEntidad.id_empresa</code>.
	 */
	 ...
	 */
	public Consultaforecastentidad() {
		super("consultaForecastEntidad", Matera.MATERA);
