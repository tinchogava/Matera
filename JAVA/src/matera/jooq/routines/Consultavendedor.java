...
public class Consultavendedor extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 859608184;

	/**
	 * The parameter <code>matera.consultaVendedor.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaVendedor.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaVendedor.soloHabilitados</code>.
	 */
	...
	public Consultavendedor() {
		super("consultaVendedor", Matera.MATERA);
