...
public class Consultamaparecepcion extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -2120529833;

	/**
	 * The parameter <code>matera.consultaMapaRecepcion.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMapaRecepcion.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMapaRecepcion.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaMapaRecepcion.id_empresa</code>.
	 */
	 ...
	 */
	public Consultamaparecepcion() {
		super("consultaMapaRecepcion", Matera.MATERA);
