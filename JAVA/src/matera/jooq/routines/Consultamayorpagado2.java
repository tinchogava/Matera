...
public class Consultamayorpagado2 extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 35271053;

	/**
	 * The parameter <code>matera.consultaMayorPagado2.ids</code>.
	 */
	public static final Parameter<String> IDS = createParameter("ids", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.consultaMayorPagado2.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorPagado2.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorPagado2.id_empresa</code>.
	 */
	 ...
	 */
	public Consultamayorpagado2() {
		super("consultaMayorPagado2", Matera.MATERA);
