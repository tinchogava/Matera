...
public class Cantpresufacturados extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = -824976394;

	/**
	 * The parameter <code>matera.cantPresuFacturados.RETURN_VALUE</code>.
	 */
	public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.cantPresuFacturados.id_entidad</code>.
	 */
	public static final Parameter<Integer> ID_ENTIDAD = createParameter("id_entidad", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.cantPresuFacturados.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.cantPresuFacturados.hasta</code>.
	 */
	 ...
	 */
	public Cantpresufacturados() {
		super("cantPresuFacturados", Matera.MATERA, org.jooq.impl.SQLDataType.INTEGER);
