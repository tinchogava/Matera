...
public class Traecajazona extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 605566824;

	/**
	 * The parameter <code>matera.traeCajaZona.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.traeCajaZona.id_empresa</code>.
	 */
	 ...
	 */
	public Traecajazona() {
		super("traeCajaZona", Matera.MATERA);
