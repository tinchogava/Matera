...
public class Insertpreliquidacion extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1199344008;

	/**
	 * The parameter <code>matera.insertPreliquidacion.fecha</code>.
	 */
	public static final Parameter<Date> FECHA = createParameter("fecha", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.insertPreliquidacion.id_presupuesto</code>.
	 */
	...
	/**
	 * The parameter <code>matera.insertPreliquidacion.id_profesional</code>.
	 */
	...
	/**
	 * The parameter <code>matera.insertPreliquidacion.dc</code>.
	 */
	public static final Parameter<String> DC = createParameter("dc", org.jooq.impl.SQLDataType.VARCHAR.length(1), false);

	/**
	 * The parameter <code>matera.insertPreliquidacion.importe</code>.
	 */
	...
	/**
	 * The parameter <code>matera.insertPreliquidacion.observaciones</code>.
	 */
	public static final Parameter<String> OBSERVACIONES = createParameter("observaciones", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.insertPreliquidacion.preliquidacion</code>.
	 */
	public static final Parameter<Integer> PRELIQUIDACION = createParameter("preliquidacion", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.insertPreliquidacion.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.insertPreliquidacion.usuario</code>.
	 */
	 ...
	 */
	public Insertpreliquidacion() {
		super("insertPreliquidacion", Matera.MATERA);
	...
	/**
	 * Set the <code>preliquidacion</code> parameter IN value to the routine
	 */
	public void setPreliquidacion(Integer value) {
		setValue(PRELIQUIDACION, value);
	}
