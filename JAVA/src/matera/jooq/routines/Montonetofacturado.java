...
public class Montonetofacturado extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -33685672;

	/**
	 * The parameter <code>matera.montoNetoFacturado.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>matera.montoNetoFacturado.id_presupuesto</code>.
	 */
	 ...
	 */
	public Montonetofacturado() {
		super("montoNetoFacturado", Matera.MATERA, org.jooq.impl.SQLDataType.DECIMAL.precision(20, 2));
