...
public class Consultaformapago extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1828365095;

	/**
	 * The parameter <code>matera.consultaFormaPago.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultaformapago() {
		super("consultaFormaPago", Matera.MATERA);
