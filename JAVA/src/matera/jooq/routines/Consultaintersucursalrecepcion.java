...
public class Consultaintersucursalrecepcion extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 2037671245;

	/**
	 * The parameter <code>matera.consultaIntersucursalRecepcion.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaIntersucursalRecepcion.id_zonaDestino</code>.
	 */
	...
	/**
	 * The parameter <code>matera.consultaIntersucursalRecepcion.id_empresa</code>.
	 */
	 ...
	 */
	public Consultaintersucursalrecepcion() {
		super("consultaIntersucursalRecepcion", Matera.MATERA);
