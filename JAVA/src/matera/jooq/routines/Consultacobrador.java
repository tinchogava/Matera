...
public class Consultacobrador extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1136239935;

	/**
	 * The parameter <code>matera.consultaCobrador.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaCobrador.soloHabilitados</code>.
	 */
	...
	public Consultacobrador() {
		super("consultaCobrador", Matera.MATERA);
