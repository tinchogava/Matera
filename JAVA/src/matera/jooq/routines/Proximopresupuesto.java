...
public class Proximopresupuesto extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = 1914932718;

	/**
	 * The parameter <code>matera.proximoPresupuesto.RETURN_VALUE</code>.
	 */
	public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.proximoPresupuesto.id_empresa</code>.
	 */
	 ...
	 */
	public Proximopresupuesto() {
		super("proximoPresupuesto", Matera.MATERA, org.jooq.impl.SQLDataType.INTEGER);
