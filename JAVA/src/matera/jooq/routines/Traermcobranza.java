...
public class Traermcobranza extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 628447345;

	/**
	 * The parameter <code>matera.traeRmCobranza.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>matera.traeRmCobranza.id_presupuesto</code>.
	 */
	 ...
	 */
	public Traermcobranza() {
		super("traeRmCobranza", Matera.MATERA, org.jooq.impl.SQLDataType.DECIMAL.precision(9, 2));
