...
public class Consultapresuhonorarios extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1886237256;

	/**
	 * The parameter <code>matera.consultaPresuHonorarios.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaPresuHonorarios.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaPresuHonorarios.id_prestacion</code>.
	 */
	 ...
	 */
	public Consultapresuhonorarios() {
		super("consultaPresuHonorarios", Matera.MATERA);
