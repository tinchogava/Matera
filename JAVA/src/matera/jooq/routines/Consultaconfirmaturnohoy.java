...
public class Consultaconfirmaturnohoy extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1880984463;

	/**
	 * The parameter <code>matera.consultaConfirmaTurnoHoy.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaConfirmaTurnoHoy.id_empresa</code>.
	 */
	 ...
	 */
	public Consultaconfirmaturnohoy() {
		super("consultaConfirmaTurnoHoy", Matera.MATERA);
