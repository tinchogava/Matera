...
public class Consultaconsolidadocobranza extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -9829326;

	/**
	 * The parameter <code>matera.consultaConsolidadoCobranza.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaConsolidadoCobranza.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaConsolidadoCobranza.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaConsolidadoCobranza.id_entidad</code>.
	 */
	public static final Parameter<Integer> ID_ENTIDAD = createParameter("id_entidad", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaConsolidadoCobranza.operaciones</code>.
	 */
	...
	/**
	 * The parameter <code>matera.consultaConsolidadoCobranza.entidad</code>.
	 */
	public static final Parameter<Byte> ENTIDAD = createParameter("entidad", org.jooq.impl.SQLDataType.TINYINT, false);

	/**
	 * The parameter <code>matera.consultaConsolidadoCobranza.id_empresa</code>.
	 */
	 ...
	 */
	public Consultaconsolidadocobranza() {
		super("consultaConsolidadoCobranza", Matera.MATERA);
