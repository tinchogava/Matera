...
public class Consultaproveedor extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 518552637;

	/**
	 * The parameter <code>matera.consultaProveedor.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaProveedor.soloHabilitados</code>.
	 */
	...
	public Consultaproveedor() {
		super("consultaProveedor", Matera.MATERA);
