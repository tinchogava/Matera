...
public class Consultaprestacion extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1944788065;

	/**
	 * The parameter <code>matera.consultaPrestacion.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaPrestacion.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultaprestacion() {
		super("consultaPrestacion", Matera.MATERA);
