...
public class Consultacajadeposito extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 912163259;

	/**
	 * The parameter <code>matera.consultaCajaDeposito.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaCajaDeposito.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultacajadeposito() {
		super("consultaCajaDeposito", Matera.MATERA);
