...
public class Consultaremitosturno extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1039296579;

	/**
	 * The parameter <code>matera.consultaRemitosTurno.id_presupuesto</code>.
	 */
	 ...
	 */
	public Consultaremitosturno() {
		super("consultaRemitosTurno", Matera.MATERA);
