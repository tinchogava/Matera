...
public class Insertsubespecialidad extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1944407042;

	/**
	 * The parameter <code>matera.insertSubespecialidad.id_subespecialidad</code>.
	 */
	...
	/**
	 * The parameter <code>matera.insertSubespecialidad.id_especialidad</code>.
	 */
	...
	/**
	 * The parameter <code>matera.insertSubespecialidad.nombre</code>.
	 */
	public static final Parameter<String> NOMBRE = createParameter("nombre", org.jooq.impl.SQLDataType.VARCHAR.length(45), false);

	/**
	 * The parameter <code>matera.insertSubespecialidad.habilita</code>.
	 */
	 ...
	 */
	public Insertsubespecialidad() {
		super("insertSubespecialidad", Matera.MATERA);
