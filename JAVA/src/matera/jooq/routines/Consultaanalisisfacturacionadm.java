...
public class Consultaanalisisfacturacionadm extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 399744533;

	/**
	 * The parameter <code>matera.consultaAnalisisFacturacionAdm.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaAnalisisFacturacionAdm.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaAnalisisFacturacionAdm.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaAnalisisFacturacionAdm.id_especialidad</code>.
	 */
	...
	/**
	 * The parameter <code>matera.consultaAnalisisFacturacionAdm.id_empresa</code>.
	 */
	 ...
	 */
	public Consultaanalisisfacturacionadm() {
		super("consultaAnalisisFacturacionAdm", Matera.MATERA);
