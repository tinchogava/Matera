...
public class Traehaberpreliquidacion extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1316152655;

	/**
	 * The parameter <code>matera.traeHaberPreliquidacion.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>matera.traeHaberPreliquidacion.id_presupuesto</code>.
	 */
	...
	/**
	 * The parameter <code>matera.traeHaberPreliquidacion.id_profesional</code>.
	 */
	 ...
	 */
	public Traehaberpreliquidacion() {
		super("traeHaberPreliquidacion", Matera.MATERA, org.jooq.impl.SQLDataType.DECIMAL.precision(9, 2));
