...
public class Consultacomprobantesasociados extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -376881346;

	/**
	 * The parameter <code>matera.consultaComprobantesAsociados.id_presupuesto</code>.
	 */
	...
	/**
	 * The parameter <code>matera.consultaComprobantesAsociados.id_empresa</code>.
	 */
	 ...
	 */
	public Consultacomprobantesasociados() {
		super("consultaComprobantesAsociados", Matera.MATERA);
