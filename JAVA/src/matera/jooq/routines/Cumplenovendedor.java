...
public class Cumplenovendedor extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1408164237;

	/**
	 * The parameter <code>matera.cumpleNoVendedor.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.cumpleNoVendedor.mes</code>.
	 */
	public static final Parameter<Integer> MES = createParameter("mes", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.cumpleNoVendedor.id_zona</code>.
	 */
	 ...
	 */
	public Cumplenovendedor() {
		super("cumpleNoVendedor", Matera.MATERA);
