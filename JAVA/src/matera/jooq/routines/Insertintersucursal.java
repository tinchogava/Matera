...
public class Insertintersucursal extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -673425808;

	/**
	 * The parameter <code>matera.insertIntersucursal.usuario</code>.
	 */
	public static final Parameter<String> USUARIO = createParameter("usuario", org.jooq.impl.SQLDataType.VARCHAR.length(45), false);

	/**
	 * The parameter <code>matera.insertIntersucursal.id_empresa</code>.
	 */
	 ...
	 */
	public Insertintersucursal() {
		super("insertIntersucursal", Matera.MATERA);
