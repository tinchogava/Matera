...
public class Selectentidad extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 683479001;

	/**
	 * The parameter <code>matera.selectEntidad.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.selectEntidad.soloHabilitados</code>.
	 */
	...
	public Selectentidad() {
		super("selectEntidad", Matera.MATERA);
