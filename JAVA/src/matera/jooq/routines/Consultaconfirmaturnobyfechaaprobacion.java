...
public class Consultaconfirmaturnobyfechaaprobacion extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1309466298;

	/**
	 * The parameter <code>matera.consultaConfirmaTurnoByFechaAprobacion.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaConfirmaTurnoByFechaAprobacion.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaConfirmaTurnoByFechaAprobacion.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaConfirmaTurnoByFechaAprobacion.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaConfirmaTurnoByFechaAprobacion.tipoBusqueda</code>.
	 */
	 ...
	 */
	public Consultaconfirmaturnobyfechaaprobacion() {
		super("consultaConfirmaTurnoByFechaAprobacion", Matera.MATERA);
