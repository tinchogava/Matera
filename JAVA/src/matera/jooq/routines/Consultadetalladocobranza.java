...
public class Consultadetalladocobranza extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1616081190;

	/**
	 * The parameter <code>matera.consultaDetalladoCobranza.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaDetalladoCobranza.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaDetalladoCobranza.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaDetalladoCobranza.id_entidad</code>.
	 */
	public static final Parameter<Integer> ID_ENTIDAD = createParameter("id_entidad", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaDetalladoCobranza.operaciones</code>.
	 */
	...
	/**
	 * The parameter <code>matera.consultaDetalladoCobranza.entidad</code>.
	 */
	public static final Parameter<Byte> ENTIDAD = createParameter("entidad", org.jooq.impl.SQLDataType.TINYINT, false);

	/**
	 * The parameter <code>matera.consultaDetalladoCobranza.id_empresa</code>.
	 */
	 ...
	 */
	public Consultadetalladocobranza() {
		super("consultaDetalladoCobranza", Matera.MATERA);
