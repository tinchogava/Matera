...
public class Montopresuaprobados extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1775735919;

	/**
	 * The parameter <code>matera.montoPresuAprobados.RETURN_VALUE</code>.
	 */
	 ...
	 */
	public Montopresuaprobados() {
		super("montoPresuAprobados", Matera.MATERA, org.jooq.impl.SQLDataType.DECIMAL.precision(20, 2));
