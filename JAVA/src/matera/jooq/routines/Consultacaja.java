...
public class Consultacaja extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -288988339;

	/**
	 * The parameter <code>matera.consultaCaja.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultacaja() {
		super("consultaCaja", Matera.MATERA);
