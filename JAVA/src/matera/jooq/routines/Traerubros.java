...
public class Traerubros extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1384428881;

	/**
	 * The parameter <code>matera.traeRubros.id_empresa</code>.
	 */
	 ...
	 */
	public Traerubros() {
		super("traeRubros", Matera.MATERA);
