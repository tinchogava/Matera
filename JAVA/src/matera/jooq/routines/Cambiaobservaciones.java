...
public class Cambiaobservaciones extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 417431413;

	/**
	 * The parameter <code>matera.cambiaObservaciones.id_presupuesto</code>.
	 */
	...
	/**
	 * The parameter <code>matera.cambiaObservaciones.observaciones</code>.
	 */
	public static final Parameter<String> OBSERVACIONES = createParameter("observaciones", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.cambiaObservaciones.usuario</code>.
	 */
	 ...
	 */
	public Cambiaobservaciones() {
		super("cambiaObservaciones", Matera.MATERA);
