...
public class Traeremitocaja extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1607918636;

	/**
	 * The parameter <code>matera.traeRemitoCaja.id_remito</code>.
	 */
	 ...
	 */
	public Traeremitocaja() {
		super("traeRemitoCaja", Matera.MATERA);
