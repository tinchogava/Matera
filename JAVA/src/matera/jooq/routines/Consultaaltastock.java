...
public class Consultaaltastock extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 385549785;

	/**
	 * The parameter <code>matera.consultaAltaStock.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaAltaStock.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaAltaStock.id_empresa</code>.
	 */
	 ...
	 */
	public Consultaaltastock() {
		super("consultaAltaStock", Matera.MATERA);
