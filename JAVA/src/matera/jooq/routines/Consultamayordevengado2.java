...
public class Consultamayordevengado2 extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1018225964;

	/**
	 * The parameter <code>matera.consultaMayorDevengado2.ids</code>.
	 */
	public static final Parameter<String> IDS = createParameter("ids", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.consultaMayorDevengado2.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorDevengado2.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorDevengado2.id_empresa</code>.
	 */
	 ...
	 */
	public Consultamayordevengado2() {
		super("consultaMayorDevengado2", Matera.MATERA);
