...
public class Consultaanalisiscobranza extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1169007290;

	/**
	 * The parameter <code>matera.consultaAnalisisCobranza.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaAnalisisCobranza.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaAnalisisCobranza.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaAnalisisCobranza.id_empresa</code>.
	 */
	 ...
	 */
	public Consultaanalisiscobranza() {
		super("consultaAnalisisCobranza", Matera.MATERA);
