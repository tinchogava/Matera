...
public class Cantpresuemitidos extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = 349035060;

	/**
	 * The parameter <code>matera.cantPresuEmitidos.RETURN_VALUE</code>.
	 */
	public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.cantPresuEmitidos.id_entidad</code>.
	 */
	public static final Parameter<Integer> ID_ENTIDAD = createParameter("id_entidad", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.cantPresuEmitidos.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.cantPresuEmitidos.hasta</code>.
	 */
	 ...
	 */
	public Cantpresuemitidos() {
		super("cantPresuEmitidos", Matera.MATERA, org.jooq.impl.SQLDataType.INTEGER);
