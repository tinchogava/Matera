...
public class Anulacircuito extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1400958120;

	/**
	 * The parameter <code>matera.anulaCircuito.id_presupuesto</code>.
	 */
	...
	/**
	 * The parameter <code>matera.anulaCircuito.usuario</code>.
	 */
	 ...
	 */
	public Anulacircuito() {
		super("anulaCircuito", Matera.MATERA);
