...
public class Consultacostoventas extends AbstractRoutine<java.lang.Void> {
	 ...
	 */
	public Consultacostoventas() {
		super("consultaCostoVentas", Matera.MATERA);
