...
public class Consultavendedorcomision extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 678218791;

	/**
	 * The parameter <code>matera.consultaVendedorComision.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaVendedorComision.id_especialidad</code>.
	 */
	...
	/**
	 * The parameter <code>matera.consultaVendedorComision.id_empresa</code>.
	 */
	 ...
	 */
	public Consultavendedorcomision() {
		super("consultaVendedorComision", Matera.MATERA);
