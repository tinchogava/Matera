...
public class Traepresupuestoprod extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1151929761;

	/**
	 * The parameter <code>matera.traePresupuestoProd.id_presupuesto</code>.
	 */
	 ...
	 */
	public Traepresupuestoprod() {
		super("traePresupuestoProd", Matera.MATERA);
