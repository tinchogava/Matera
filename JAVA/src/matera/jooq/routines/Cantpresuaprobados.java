...
public class Cantpresuaprobados extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = 1392921675;

	/**
	 * The parameter <code>matera.cantPresuAprobados.RETURN_VALUE</code>.
	 */
	public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.cantPresuAprobados.id_entidad</code>.
	 */
	public static final Parameter<Integer> ID_ENTIDAD = createParameter("id_entidad", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.cantPresuAprobados.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.cantPresuAprobados.hasta</code>.
	 */
	 ...
	 */
	public Cantpresuaprobados() {
		super("cantPresuAprobados", Matera.MATERA, org.jooq.impl.SQLDataType.INTEGER);
