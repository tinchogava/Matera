...
public class Traedebepreliquidacion extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -1977782065;

	/**
	 * The parameter <code>matera.traeDebePreliquidacion.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>matera.traeDebePreliquidacion.id_presupuesto</code>.
	 */
	...
	/**
	 * The parameter <code>matera.traeDebePreliquidacion.id_profesional</code>.
	 */
	 ...
	 */
	public Traedebepreliquidacion() {
		super("traeDebePreliquidacion", Matera.MATERA, org.jooq.impl.SQLDataType.DECIMAL.precision(9, 2));
