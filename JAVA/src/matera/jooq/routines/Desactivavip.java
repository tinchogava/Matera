...
public class Desactivavip extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -467242745;

	/**
	 * The parameter <code>matera.desactivaVip.id_presupuesto</code>.
	 */
	 ...
	 */
	public Desactivavip() {
		super("desactivaVip", Matera.MATERA);
