...
public class Usuarioadministrador extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1267211486;

	/**
	 * The parameter <code>matera.usuarioAdministrador.id_usuario</code>.
	 */
	public static final Parameter<Integer> ID_USUARIO = createParameter("id_usuario", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.usuarioAdministrador.id_empresa</code>.
	 */
	...
	public Usuarioadministrador() {
		super("usuarioAdministrador", Matera.MATERA);
