...
public class Modificaremitoconsumido extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1463708040;

	/**
	 * The parameter <code>matera.modificaRemitoConsumido.id_remito</code>.
	 */
	public static final Parameter<Integer> ID_REMITO = createParameter("id_remito", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.modificaRemitoConsumido.observaciones</code>.
	 */
	public static final Parameter<String> OBSERVACIONES = createParameter("observaciones", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.modificaRemitoConsumido.usuario</code>.
	 */
	 ...
	 */
	public Modificaremitoconsumido() {
		super("modificaRemitoConsumido", Matera.MATERA);
