...
public class Consultastock extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1406042334;

	/**
	 * The parameter <code>matera.consultaStock.id_proveedor</code>.
	 */
	public static final Parameter<Integer> ID_PROVEEDOR = createParameter("id_proveedor", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaStock.id_clasiProducto</code>.
	 */
	...
	public Consultastock() {
		super("consultaStock", Matera.MATERA);
