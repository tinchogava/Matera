...
public class Consultamayorpendiente extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 663215345;

	/**
	 * The parameter <code>matera.consultaMayorPendiente.ids</code>.
	 */
	public static final Parameter<String> IDS = createParameter("ids", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.consultaMayorPendiente.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorPendiente.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorPendiente.id_empresa</code>.
	 */
	 ...
	 */
	public Consultamayorpendiente() {
		super("consultaMayorPendiente", Matera.MATERA);
