...
public class Desactivapresupuesto extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1389396635;

	/**
	 * The parameter <code>matera.desactivaPresupuesto.id_presupuesto</code>.
	 */
	 ...
	 */
	public Desactivapresupuesto() {
		super("desactivaPresupuesto", Matera.MATERA);
