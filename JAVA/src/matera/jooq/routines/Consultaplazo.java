...
public class Consultaplazo extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 152504097;

	/**
	 * The parameter <code>matera.consultaPlazo.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultaplazo() {
		super("consultaPlazo", Matera.MATERA);
