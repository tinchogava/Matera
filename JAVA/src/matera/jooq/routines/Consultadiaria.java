...
public class Consultadiaria extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1280052365;

	/**
	 * The parameter <code>matera.consultaDiaria.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaDiaria.soloHabilitados</code>.
	 */
	...
	public Consultadiaria() {
		super("consultaDiaria", Matera.MATERA);
