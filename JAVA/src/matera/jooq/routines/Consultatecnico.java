...
public class Consultatecnico extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 760268354;

	/**
	 * The parameter <code>matera.consultaTecnico.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaTecnico.soloHabilitados</code>.
	 */
	...
	public Consultatecnico() {
		super("consultaTecnico", Matera.MATERA);
