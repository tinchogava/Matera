...
public class Consultadiferenciasintersucursal extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 864047351;

	/**
	 * The parameter <code>matera.consultaDiferenciasIntersucursal.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaDiferenciasIntersucursal.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaDiferenciasIntersucursal.id_empresa</code>.
	 */
	 ...
	 */
	public Consultadiferenciasintersucursal() {
		super("consultaDiferenciasIntersucursal", Matera.MATERA);
