...
public class Deletepresupuestoprod extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1350327277;

	/**
	 * The parameter <code>matera.deletePresupuestoProd.id_presupuesto</code>.
	 */
	 ...
	 */
	public Deletepresupuestoprod() {
		super("deletePresupuestoProd", Matera.MATERA);
