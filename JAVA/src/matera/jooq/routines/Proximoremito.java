...
public class Proximoremito extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = -610662143;

	/**
	 * The parameter <code>matera.proximoRemito.RETURN_VALUE</code>.
	 */
	public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.proximoRemito.id_empresa</code>.
	 */
	 ...
	 */
	public Proximoremito() {
		super("proximoRemito", Matera.MATERA, org.jooq.impl.SQLDataType.INTEGER);
