...
public class Consultaprestacionsinorden extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1313692141;

	/**
	 * The parameter <code>matera.consultaPrestacionSinOrden.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaPrestacionSinOrden.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultaprestacionsinorden() {
		super("consultaPrestacionSinOrden", Matera.MATERA);
