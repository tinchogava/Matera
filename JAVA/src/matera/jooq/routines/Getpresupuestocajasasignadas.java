...
public class Getpresupuestocajasasignadas extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1502747413;

	/**
	 * The parameter <code>matera.getPresupuestoCajasAsignadas.id_presupuesto</code>.
	 */
	 ...
	 */
	public Getpresupuestocajasasignadas() {
		super("getPresupuestoCajasAsignadas", Matera.MATERA);
