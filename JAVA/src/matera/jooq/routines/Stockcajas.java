...
public class Stockcajas extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -379894106;

	/**
	 * The parameter <code>matera.stockCajas.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.stockCajas.id_caja</code>.
	 */
	public static final Parameter<Integer> ID_CAJA = createParameter("id_caja", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.stockCajas.id_empresa</code>.
	 */
	 ...
	 */
	public Stockcajas() {
		super("stockCajas", Matera.MATERA);
