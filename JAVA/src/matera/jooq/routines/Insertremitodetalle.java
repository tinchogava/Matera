...
public class Insertremitodetalle extends AbstractRoutine<java.lang.Void> {
	 ...
	 */
	public Insertremitodetalle() {
		super("insertRemitoDetalle", Matera.MATERA);
