...
public class Armabotonesdetalleforecast extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 71800050;

	/**
	 * The parameter <code>matera.armaBotonesDetalleForecast.id_entidad</code>.
	 */
	public static final Parameter<Integer> ID_ENTIDAD = createParameter("id_entidad", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.armaBotonesDetalleForecast.id_vendedor</code>.
	 */
	public static final Parameter<Integer> ID_VENDEDOR = createParameter("id_vendedor", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.armaBotonesDetalleForecast.id_productoFact</code>.
	 */
	...
	/**
	 * The parameter <code>matera.armaBotonesDetalleForecast.anio</code>.
	 */
	public static final Parameter<Integer> ANIO = createParameter("anio", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.armaBotonesDetalleForecast.mes</code>.
	 */
	 ...
	 */
	public Armabotonesdetalleforecast() {
		super("armaBotonesDetalleForecast", Matera.MATERA);
