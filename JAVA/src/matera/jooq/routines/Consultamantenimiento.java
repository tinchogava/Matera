...
public class Consultamantenimiento extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1528606343;

	/**
	 * The parameter <code>matera.consultaMantenimiento.soloHabilitados</code>.
	 */
	...
	public Consultamantenimiento() {
		super("consultaMantenimiento", Matera.MATERA);
