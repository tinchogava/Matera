...
public class Consultamayorcomposicion extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -937034418;

	/**
	 * The parameter <code>matera.consultaMayorComposicion.ids</code>.
	 */
	public static final Parameter<String> IDS = createParameter("ids", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.consultaMayorComposicion.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorComposicion.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorComposicion.id_empresa</code>.
	 */
	 ...
	 */
	public Consultamayorcomposicion() {
		super("consultaMayorComposicion", Matera.MATERA);
