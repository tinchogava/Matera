...
public class Consultaintersucursalrecibedevolucion extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1260836537;

	/**
	 * The parameter <code>matera.consultaIntersucursalRecibeDevolucion.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaIntersucursalRecibeDevolucion.id_zonaDestino</code>.
	 */
	...
	/**
	 * The parameter <code>matera.consultaIntersucursalRecibeDevolucion.id_empresa</code>.
	 */
	 ...
	 */
	public Consultaintersucursalrecibedevolucion() {
		super("consultaIntersucursalRecibeDevolucion", Matera.MATERA);
