...
public class Consultaclasiproducto extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1963374985;

	/**
	 * The parameter <code>matera.consultaClasiProducto.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultaclasiproducto() {
		super("consultaClasiProducto", Matera.MATERA);
