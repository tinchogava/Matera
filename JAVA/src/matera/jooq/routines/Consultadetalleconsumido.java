...
public class Consultadetalleconsumido extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1073498681;

	/**
	 * The parameter <code>matera.consultaDetalleConsumido.id_presupuesto</code>.
	 */
	 ...
	 */
	public Consultadetalleconsumido() {
		super("consultaDetalleConsumido", Matera.MATERA);
