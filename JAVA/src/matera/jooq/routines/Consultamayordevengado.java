...
public class Consultamayordevengado extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 2010459014;

	/**
	 * The parameter <code>matera.consultaMayorDevengado.ids</code>.
	 */
	public static final Parameter<String> IDS = createParameter("ids", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.consultaMayorDevengado.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorDevengado.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorDevengado.id_empresa</code>.
	 */
	 ...
	 */
	public Consultamayordevengado() {
		super("consultaMayorDevengado", Matera.MATERA);
