...
public class Consultaclasientidad extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1716966849;

	/**
	 * The parameter <code>matera.consultaClasiEntidad.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultaclasientidad() {
		super("consultaClasiEntidad", Matera.MATERA);
