...
public class Consultaespecialidad extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 965273779;

	/**
	 * The parameter <code>matera.consultaEspecialidad.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultaespecialidad() {
		super("consultaEspecialidad", Matera.MATERA);
