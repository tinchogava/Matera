...
public class Traerm extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 161225283;

	/**
	 * The parameter <code>matera.traeRM.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>matera.traeRM.id_presupuesto</code>.
	 */
	 ...
	 */
	public Traerm() {
		super("traeRM", Matera.MATERA, org.jooq.impl.SQLDataType.DECIMAL.precision(9, 2));
