...
public class Proximaliquidacion extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = -379722445;

	/**
	 * The parameter <code>matera.proximaLiquidacion.RETURN_VALUE</code>.
	 */
	public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.proximaLiquidacion.id_empresa</code>.
	 */
	 ...
	 */
	public Proximaliquidacion() {
		super("proximaLiquidacion", Matera.MATERA, org.jooq.impl.SQLDataType.INTEGER);
