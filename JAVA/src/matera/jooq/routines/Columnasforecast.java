...
public class Columnasforecast extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1218338844;

	/**
	 * The parameter <code>matera.columnasForecast.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.columnasForecast.id_empresa</code>.
	 */
	 ...
	 */
	public Columnasforecast() {
		super("columnasForecast", Matera.MATERA);
