...
public class Consultamayorcomposicion2 extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1019470020;

	/**
	 * The parameter <code>matera.consultaMayorComposicion2.ids</code>.
	 */
	public static final Parameter<String> IDS = createParameter("ids", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.consultaMayorComposicion2.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorComposicion2.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorComposicion2.id_empresa</code>.
	 */
	 ...
	 */
	public Consultamayorcomposicion2() {
		super("consultaMayorComposicion2", Matera.MATERA);
