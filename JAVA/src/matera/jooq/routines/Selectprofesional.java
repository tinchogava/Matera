...
public class Selectprofesional extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1774689622;

	/**
	 * The parameter <code>matera.selectProfesional.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.selectProfesional.soloHabilitados</code>.
	 */
	 ...
	 */
	public Selectprofesional() {
		super("selectProfesional", Matera.MATERA);
