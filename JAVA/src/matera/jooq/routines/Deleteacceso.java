...
public class Deleteacceso extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -364213470;

	/**
	 * The parameter <code>matera.deleteAcceso.id_usuario</code>.
	 */
	public static final Parameter<Integer> ID_USUARIO = createParameter("id_usuario", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.deleteAcceso.id_empresa</code>.
	 */
	 ...
	 */
	public Deleteacceso() {
		super("deleteAcceso", Matera.MATERA);
