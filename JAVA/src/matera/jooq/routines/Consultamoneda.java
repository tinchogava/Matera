...
public class Consultamoneda extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1425693739;

	/**
	 * The parameter <code>matera.consultaMoneda.soloHabilitados</code>.
	 */
	...
	public Consultamoneda() {
		super("consultaMoneda", Matera.MATERA);
