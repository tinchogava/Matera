...
public class Consultaasignadas extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -550291125;

	/**
	 * The parameter <code>matera.consultaAsignadas.id_presupuesto</code>.
	 */
	 ...
	 */
	public Consultaasignadas() {
		super("consultaAsignadas", Matera.MATERA);
