...
public class Consultacontrolprecios extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 1623774001;

	/**
	 * The parameter <code>matera.consultaControlPrecios.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaControlPrecios.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaControlPrecios.id_empresa</code>.
	 */
	 ...
	 */
	public Consultacontrolprecios() {
		super("consultaControlPrecios", Matera.MATERA);
