...
public class Consultamayorgeneral2 extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -1518365189;

	/**
	 * The parameter <code>matera.consultaMayorGeneral2.ids</code>.
	 */
	public static final Parameter<String> IDS = createParameter("ids", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>matera.consultaMayorGeneral2.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorGeneral2.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaMayorGeneral2.id_empresa</code>.
	 */
	 ...
	 */
	public Consultamayorgeneral2() {
		super("consultaMayorGeneral2", Matera.MATERA);
