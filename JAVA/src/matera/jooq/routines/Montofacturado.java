...
public class Montofacturado extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1104702786;

	/**
	 * The parameter <code>matera.montoFacturado.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>matera.montoFacturado.id_presupuesto</code>.
	 */
	 ...
	 */
	public Montofacturado() {
		super("montoFacturado", Matera.MATERA, org.jooq.impl.SQLDataType.DECIMAL.precision(9, 2));
