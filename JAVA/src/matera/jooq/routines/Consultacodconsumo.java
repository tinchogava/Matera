...
public class Consultacodconsumo extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -917849669;

	/**
	 * The parameter <code>matera.consultaCodConsumo.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultacodconsumo() {
		super("consultaCodConsumo", Matera.MATERA);
