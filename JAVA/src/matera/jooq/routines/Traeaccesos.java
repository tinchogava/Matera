...
public class Traeaccesos extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -660004150;

	/**
	 * The parameter <code>matera.traeAccesos.id_usuario</code>.
	 */
	public static final Parameter<Integer> ID_USUARIO = createParameter("id_usuario", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.traeAccesos.id_empresa</code>.
	 */
	 ...
	 */
	public Traeaccesos() {
		super("traeAccesos", Matera.MATERA);
