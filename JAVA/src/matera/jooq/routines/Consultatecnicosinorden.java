...
public class Consultatecnicosinorden extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = -701531888;

	/**
	 * The parameter <code>matera.consultaTecnicoSinOrden.id_empresa</code>.
	 */
	public static final Parameter<Integer> ID_EMPRESA = createParameter("id_empresa", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaTecnicoSinOrden.soloHabilitados</code>.
	 */
	 ...
	 */
	public Consultatecnicosinorden() {
		super("consultaTecnicoSinOrden", Matera.MATERA);
