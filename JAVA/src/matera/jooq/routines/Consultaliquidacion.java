...
public class Consultaliquidacion extends AbstractRoutine<java.lang.Void> {

	private static final long serialVersionUID = 2034656889;

	/**
	 * The parameter <code>matera.consultaLiquidacion.desde</code>.
	 */
	public static final Parameter<Date> DESDE = createParameter("desde", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaLiquidacion.hasta</code>.
	 */
	public static final Parameter<Date> HASTA = createParameter("hasta", org.jooq.impl.SQLDataType.DATE, false);

	/**
	 * The parameter <code>matera.consultaLiquidacion.id_zona</code>.
	 */
	public static final Parameter<Integer> ID_ZONA = createParameter("id_zona", org.jooq.impl.SQLDataType.INTEGER, false);

	/**
	 * The parameter <code>matera.consultaLiquidacion.id_profesional</code>.
	 */
	...
	/**
	 * The parameter <code>matera.consultaLiquidacion.id_empresa</code>.
	 */
	 ...
	 */
	public Consultaliquidacion() {
		super("consultaLiquidacion", Matera.MATERA);
