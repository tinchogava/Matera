...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `calculaGanancia`(base DECIMAL(9,2)) RETURNS decimal(9,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `calculaIIBB`(neto DECIMAL(9,2),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `cantPresuAprobados`(id_entidad INT,
                                                                desde DATE,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `cantPresuEmitidos`(id_entidad INT,
                                                                desde DATE,
                                                                hasta DATE) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `cantPresuFacturados`(id_entidad INT,
                                                                    desde DATE,
                                                                    hasta DATE) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `costoPesos`(id_producto INT) RETURNS decimal(15,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `detalleLiquidacion`(id_liquidacion INT) RETURNS text CHARSET latin1
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `devengado`(id_presupuesto INT, fechaCirugia DATE) RETURNS tinyint(1)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `diasDiferencia`(fechaRecibo DATE, fechaFactura DATE) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` FUNCTION `facturaAntes`(id_presupuesto INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fechaComprobante`(id_tipoComp INT,
                                            numComp VARCHAR(12),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` FUNCTION `is_id_in_ids`(`strIDs` TEXT,`_id` BIGINT) RETURNS bit(1)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `montoFactTotal`(id_entidad INT,
                                                            desde DATE,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `montoFacturado`(id_presupuesto INT) RETURNS decimal(9,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `montoNetoFacturado`(id_presupuesto INT) RETURNS decimal(20,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `montoPresuAprobados`(id_entidad INT,
                                                                    desde DATE,
                                                                    hasta DATE) RETURNS decimal(20,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `montoPresuEmitidos`(id_entidad INT,
                                                                desde DATE,
                                                                hasta DATE) RETURNS decimal(20,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `montoPresupuesto`(id_presupuesto INT) RETURNS decimal(9,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `proximaLiquidacion`(id_empresa INT) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `proximaPreliquidacion`(id_empresa INT) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` FUNCTION `proximoPresupuesto`(id_empresa INT) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` FUNCTION `proximoRemito`(id_empresa INT) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `saldoFactura`(id_presupuesto INT, id_empresa INT) RETURNS decimal(15,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `saldoInicialProfesional`(id_profesional INT, desde DATE, id_empresa INT) RETURNS decimal(9,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `stockSaldoInicial`(id_zona INT,id_producto INT,desde DATE,id_empresa INT) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` FUNCTION `traeDebeAnticipo`(id_profesional INT) RETURNS decimal(9,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `traeDebePreliquidacion`(id_presupuesto INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `traeHaberPreliquidacion`(id_presupuesto INT,
                                                                    id_profesional INT) RETURNS decimal(9,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `traePendiente`(id_presupuesto INT,
                                                           id_profesional INT) RETURNS decimal(9,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `traeRM`(id_presupuesto INT,
                                                    desde DATE,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `traeRmCobranza`(id_presupuesto INT) RETURNS decimal(9,2)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` FUNCTION `ultimaCotizacion`(id_moneda INT) RETURNS decimal(12,3)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizaCotizacionStockDetalle`(IN mes INT,
														año INT,
                                                        id_moneda INT,
                                                        valor DECIMAL(12,3),
                                                        id_empresa INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `actualizaFactura`(IN id_factura INT,
                                                            fecha DATE,
                                                            id_tipoComp INT,
                                                            numComp VARCHAR(12),
                                                            id_tipoCompRel INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `actualizaLiquidacionTecnico`(IN id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `anulaCircuito`(IN id_presupuesto INT,
                                            usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `anulaLiquidacion`(IN id_liquidacion INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `aplicaAnticipo`(IN id_profesional INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `armaBotonesDetalleForecast`(IN id_entidad INT,
													id_vendedor INT,
                                                    id_productoFact INT,
                                                    anio INT,
                                                    mes INT)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `armaForecastEntidad`(IN id_entidad INT,
											anio INT,
											mes INT,
                                            id_vendedor INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cambiaContraseña`(IN id_usuario INT,
                                                        pass VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `cambiaObservaciones`(IN id_presupuesto INT,
											observaciones TEXT,
                                            usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cambiaPrecios`(IN id_producto INT,
                                                        costo DECIMAL(12,3))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cambioPrecio`(IN costoPesos DECIMAL(12,2),
													id_producto INT,
                                                    id_stockDetalle INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `chequeaStock`(IN id_stock INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `columnasForecast`(IN id_zona INT,
										id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `confirmaTurno`(IN id_presupuesto INT,
                                                        id_tecnico INT,
                                                        id_prestacion INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaAltaStock`(IN desde DATE,
                                                                    hasta DATE,
                                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaAnalisisCobranza`(IN desde DATE,
                                                        hasta DATE,
                                                        id_zona INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaAnalisisFacturacion`(IN desde DATE,
                                                                    hasta DATE,
                                                                    id_zona INT,
                                                                    id_especialidad INT,
                                                                    id_empresa INT)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaAnalisisFacturacionAdm`(IN desde DATE,
                                                                    hasta DATE,
                                                                    id_zona INT,
                                                                    id_especialidad INT,
                                                                    id_empresa INT)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaAnticipoAplicacion`(IN id_profesional INT,
                                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaAsignadas`(IN id_presupuesto INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaCaja`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaCajaComposicion`(IN id_cajaDeposito INT)
BEGIN

SELECT cajacomposicion.cantidad, cajacomposicion.id_producto, 
    producto.codigo as codigo, producto.nombre as producto, producto.pm as pm,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaCajaDeposito`(IN id_empresa INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaCajaPrestada`(IN id_zonaDestino INT,
											id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaCambioPrecios`(IN id_clasiProducto INT,
                                                                id_proveedor INT,
                                                                    id_empresa INT)
BEGIN

SELECT producto.id_producto, producto.codigo, producto.nombre, 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaCertificadosSinControl`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaClasiEntidad`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaClasiProducto`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaCobrador`(IN id_empresa INT,
                                                        soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaCodConsumo`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaComision`(IN desde DATE,
                                                            hasta DATE,
                                                            id_vendedor INT,
                                                            id_especialidad INT,
                                                            id_zona INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaComparativas`(IN desde DATE,
                                                            hasta DATE,
                                                            id_entidad INT,
                                                            id_productoFact INT,
                                                            id_profesional INT,
...
SELECT presupuesto.id_presupuesto as turno, presupuesto.fecha,
    productoFact.codigo as codigo, productoFact.nombre as producto, profesional.nombre as profesional,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaComprobantesAsociados`(IN id_presupuesto INT,
                                                                id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaConfirmados`(IN desde DATE,
                                                            hasta DATE,
                                                            id_zona INT,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaConfirmaTurno`(IN desde DATE,
                                                                hasta DATE,
                                                                id_zona INT,
                                                                id_empresa INT,
                                                                tipoBusqueda INT)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaConfirmaTurnoHoy`(IN id_zona INT,
                                                id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaConsolidadoCobranza`(IN desde DATE,
                                                            hasta DATE,
                                                            id_zona INT,
                                                            id_entidad INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaConsumido`(IN id_presupuesto INT,
                                                    id_empresa INT)
BEGIN

SELECT producto.codigo as producto, producto.nombre as nombre, stockDetalle.pm, stockDetalle.lote, 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaControlPrecios`(IN desde DATE,
                                                                    hasta DATE,
                                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaCostoVentas`(IN tipo INT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_zona INT,
                                                            id_proveedor INT,
...
SELECT remito.id_presupuesto as id_presupuesto, 
    ...
    producto.codigo as producto, ROUND(stockdetalle.costoPesos * stockDetalle.cotizacion, 2) as costoPesos, montoPresupuesto(remito.id_presupuesto) as montoPresupuesto,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaCotizacion`(IN id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaCumple`(IN id_empresa INT, 
                                                    mes INT(2), 
                                                    id_zona INT,
                                                    id_vendedor INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaDepartamento`(IN id_provincia INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaDetalladoCobranza`(IN desde DATE,
                                                            hasta DATE,
                                                            id_zona INT,
                                                            id_entidad INT,
                                                            operaciones VARCHAR(4),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaDetalleConsumido`(IN id_presupuesto INT)
BEGIN

SELECT producto.codigo as codigo, producto.nombre as nombre, stockDetalle.pm, 
    stockDetalle.lote, IFNULL(DATE_FORMAT(stockDetalle.vencimiento, '%d/%m/%Y'), '') as vencimiento,
    SUM(IF(stockdetalle.dc = 'C', stockDetalle.cantidad, -stockDetalle.cantidad)) as consumidoActual,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaDiaria`(IN id_empresa INT,
                                                        soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaDiferenciasIntersucursal`(IN desde DATE,
														hasta DATE,
                                                        id_empresa INT)
BEGIN

SELECT remito.fecha, remito.numComp, zona.nombre as origen, destino.nombre as destino, producto.codigo as codigo, producto.nombre as nombre,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaEmpresa`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaEntidad`(IN id_empresa INT,
                                                        id_zona INT,
                                                        soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaEspecialidad`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaEstadoSistema`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaEstrategia`(IN desde DATE,
                                                            hasta DATE,
                                                            id_profesional INT,
                                                            id_vendedor INT,
                                                            id_zona INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaEstrategiaEntidad`(IN desde DATE,
                                                            hasta DATE,
                                                            id_entidad INT,
                                                            id_zona INT,
                                                            id_empresa INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaFacturaRecibo`(IN factura INT,
                                                                desde DATE,
                                                                hasta DATE,
                                                                id_zona INT,
                                                                id_entidad INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaForecastAsignados`(IN anio INT,
												id_vendedor INT,
												id_entidad INT,
                                                id_forecastGrupo INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaForecastEntidad`(IN id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaForecastEntidades`(IN id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaForecastGrupo`(IN id_empresa INT,
											soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaFormaPago`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaHistoricoCirugias`(IN desde DATE,
												hasta DATE,
                                                id_lugarCirugia INT,
                                                id_zona INT,
                                                id_empresa INT)
...
WHERE presupuesto.id_empresa = id_empresa and
	presupuesto.estado NOT IN ('P', 'A', 'R', 'N') and
    IF(desde IS NULL, true, presupuesto.fechaCirugia >= desde) AND
    IF(hasta IS NULL, true, presupuesto.fechaCirugia <= hasta) AND
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaHistoricoOperaciones`(IN dias INT,
													id_zona INT,
                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaIntersucursalRecepcion`(IN id_zona INT,
														id_zonaDestino INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaIntersucursalRecibeDevolucion`(IN id_zona INT,
														id_zonaDestino INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaLiquidacion`(IN desde DATE,
                                                                hasta DATE,
                                                                id_zona INT,
                                                                id_profesional INT,
                                                                id_empresa INT)
...
SELECT liquidacion.fecha, profesional.nombre as profesional, 
    liquidacion.id_liquidacion, profesional.dni as dni
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaLiquidacionTecnico`(IN desde DATE,
                                                                    hasta DATE,
                                                                    id_zona INT,
                                                                    id_prestacion INT,
                                                                    id_tecnico INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaLocalidad`(IN id_departamento INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaMantenimiento`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaMapa`(IN cajas INT, 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaMapaRecepcion`(IN desde DATE,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaMayorComposicion`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaMayorComposicion2`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaMayorDevengado`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaMayorDevengado2`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaMayorGeneral`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaMayorGeneral2`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaMayorPagado`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaMayorPagado2`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaMayorPendiente`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaMayorPendiente2`(IN ids TEXT,
                                                            desde DATE,
                                                            hasta DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaModificaFactura`(IN desde DATE,
                                                                    hasta DATE,
                                                                    id_tipoComp INT,
                                                                    id_zona INT,
                                                                    id_empresa INT)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaMoneda`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaMotivo`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaMovimientosStock`(IN id_empresa INT,
                                                                                ids TEXT,
                                                                                desde DATE,
                                                                                hasta DATE,
                                                                                lote VARCHAR(45),
...
set @s = CONCAT("(SELECT ifnull(producto.codigo, '') as codigo, ifnull(producto.nombre, '') as producto, '' as dc, -1 as cantidad, '' as pm, '' as lote, null as vencimiento,",
                ...
                "UNION ALL",
                "(SELECT ifnull(producto.codigo, '') as codigo, ifnull(producto.nombre, '') as producto, stockdetalle.dc, stockdetalle.cantidad, stockdetalle.pm, UPPER(stockdetalle.lote), stockdetalle.vencimiento,",
...
execute stmt using @d, @d, @l, @l, @d, @d, @h, @h, @d, @d, @h, @h, @d, @d, @h, @h;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaMovimientosStock2`(IN id_empresa INT,
                                                                                ids TEXT,
                                                                                desde DATE,
                                                                                hasta DATE,
                                                                                lote VARCHAR(45),
                                                                                ...
                                                                                dc VARCHAR(1))
BEGIN
(SELECT ifnull(producto.codigo, '') as codigo, ifnull(producto.nombre, '') as producto, '' as dc, -1 as cantidad, '' as pm, '' as lote, null as vencimiento,
...
(SELECT ifnull(producto.codigo, '') as codigo, ifnull(producto.nombre, '') as producto, stockdetalle.dc, stockdetalle.cantidad, stockdetalle.pm, stockdetalle.lote, stockdetalle.vencimiento,
...
order by zona, producto, pm, lote, fecha;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaNegociosPendientes`(IN id_zona INT,
                                                                    id_vendedor INT,
                                                                    id_entidad INT,
                                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaNotaPresu`(IN id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaOpcion`(IN grupo INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaPendienteFacturacion`(id_entidad INT,
                                                                    id_profesional INT,
                                                                    id_zona INT,
                                                                    id_vendedor INT,
                                                                    id_empresa INT)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaPlazo`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaPlazosCobranza`(IN desde DATE,
                                                            hasta DATE,
                                                            id_zona INT,
                                                            id_entidad INT,
                                                            operaciones VARCHAR(4),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaPrestacion`(IN id_empresa INT,
                                                        soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaPresuAplicacion`(IN id_profesional INT,
                                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaPresuCertificado`(desde DATE,
																hasta DATE,
                                                                id_zona INT,
                                                                id_prestacion INT,
                                                                id_tecnico INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaPresuFactura`(IN id_zona INT,
                                                                id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaPresuHonorarios`(IN desde DATE,
                                                                    hasta DATE,
                                                                    id_prestacion INT,
                                                                    id_tecnico INT,
                                                                    id_zona INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaPresuLiquidacion`(IN id_zona INT,
                                                                    id_profesional INT,
                                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaPresuPreliquidacion`(IN id_profesional INT,
                                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaProducto`(IN id_clasiProducto INT,
                                                            id_empresa INT,
                                                            soloHabilitados BOOL)
BEGIN

SELECT producto.id_producto, producto.codigo, producto.nombre, producto.costo, producto.stockMinimo,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaProductoDesc`(IN id_clasiProducto INT,
                                                            id_empresa INT,
                                                            soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaProductoFact`(IN soloHabilitados BOOLEAN,
																		ordena INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaProfesional`(IN id_zona INT,
                                                        id_empresa INT,
                                                        soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaProfesionalMayor`(IN id_especialidad INT,
                                                                    id_zona INT,
                                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaProveedor`(IN id_empresa INT,
                                                        soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaProvincia`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaRanking`(IN desde DATE,
                                                            hasta DATE,
                                                            por INT,
                                                            id_profesional INT,
                                                            id_productoFact INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaRankingCirugias`(IN desde DATE,
												hasta DATE,
                                                por INT,
                                                id_productoFact INT,
                                                id_profesional INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaRankingVentas`(IN desde DATE,
																			hasta DATE,
                                                                            orden INT,
																			id_profesional INT,
																			id_productoFact INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaRankingVentasA`(IN desde DATE,
																			hasta DATE,
                                                                            orden INT,
																			id_profesional INT,
																			id_productoFact INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaRemito`(IN desde DATE,
                                                        hasta DATE,
                                                        id_zona INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaRemitoConsumido`(IN id_presupuesto INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaRemitoDetalleConConsumido`(IN id_remito INT)
BEGIN

SELECT producto.codigo as codigo, producto.nombre as nombre, 
	ifnull(GROUP_CONCAT(distinct (case when stockdetalle.lote='' then null else stockdetalle.lote end) separator ' / '), '') as lote,
	stockdetalle.pm, DATE_FORMAT(stockdetalle.vencimiento, '%d/%m/%Y') as vencimiento, 
	stockdetalle.cantidad as entregado, SUM(IF(remito.recibido = 'N', 0, IF(stockdetalle.dc = 'C', stockdetalle.cantidad, -stockdetalle.cantidad))) as consumido, 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaRemitosTurno`(IN id_presupuesto INT)
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaStock`(IN id_proveedor INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaSubespecialidad`(IN id_especialidad INT, 
                                                                soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaTecnico`(IN id_empresa INT,
                                                            soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaTipoComp`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaTipoOperacion`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaTrazabilidad`(IN desde DATE,
											hasta DATE,
                                            id_zona INT,
                                            id_proveedor INT,
                                            id_codConsumo INT,
...
SELECT presupuesto.id_presupuesto as id_presupuesto, presupuesto.fechaCirugia as fechaCx, producto.codigo as producto, 
    ...
    SUM(IF(stockdetalle.dc = 'C', stockdetalle.cantidad, -stockdetalle.cantidad)) as cantidad, profesional.nombre as profesional, lugar.nombre as lugar,
...
WHERE stockdetalle.id_remito IN (SELECT remito.id_remito
	...
	IF(lote = "", true, stockdetalle.lote = lote)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaTrazabilidadConsumo`(IN desde DATE,
												hasta DATE,
												id_zona INT,
												id_proveedor INT,
												id_codConsumo INT,
...
SELECT producto.codigo as producto, producto.nombre as nombreProd,
	SUM(IF(stockdetalle.dc = 'C', stockdetalle.cantidad, -stockdetalle.cantidad)) as cantidad, 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaUltimaRevision`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaUsuario`(IN id_empresa INT,
                                                        soloSistema BOOL,
                                                        soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaVendedor`(IN id_empresa INT,
                                                        id_zona INT,
                                                        soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultaVendedorComision`(IN id_zona INT,
																			id_especialidad INT,
                                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `consultaZona`(IN soloHabilitados BOOL)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `controlObrasSociales`(IN desde DATE,
                                                                hasta DATE,
                                                                id_zona INT,
                                                                id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `creaMenu`(IN id_usuario INT,
                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cumple`(IN id_empresa INT(11), IN mes INT(2), IN id_zona INT(11), IN id_vendedor INT(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cumpleNoVendedor`(IN id_empresa INT(11), IN mes INT(2), IN id_zona INT(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cumpleNoZonaNoVendedor`(IN id_empresa int(11), IN mes int(2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `deleteAcceso`(IN id_usuario INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `deleteCajaAsignada`(IN id_presupuesto INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `deleteCajaComposicion`(IN id_cajaDeposito INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `deleteForecast`(IN anio INT,
										id_vendedor INT,
                                        id_entidad INT,
                                        id_forecastGrupo INT,
                                        usuario VARCHAR(45),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `deleteForecastComposicionGrupo`(IN id_forecastGrupo INT,
														id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `deleteForecastEntidad`(IN usuario VARCHAR(45),
																equipo VARCHAR(255),
                                                                id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `deleteMayorProfesional`(IN id_mayorProfesional INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `deletePresupuestoProd`(IN id_presupuesto INT(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `deleteStockDetalle`(IN id_stock INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `desactivaPresupuesto`(IN id_presupuesto INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `desactivaVip`(IN id_presupuesto INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `detalleForecast`(IN id_vendedor INT,
										id_entidad INT,
                                        id_productoFact INT,
                                        anio INT,
                                        mes INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `devuelveIntersucursalCaja`(IN id_intersucursalCaja INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `estadoPresupuesto`(IN id_presupuesto INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `existeFactura`(IN id_tipoComp INT,
										numComp VARCHAR(12),
                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `finalizaPresupuesto`(IN id_presupuesto INT,
                                                            estado VARCHAR(1),
                                                            id_tecnico INT,
                                                            id_prestacion INT,
                                                            observaciones TEXT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `guardaConfirmaTurno`(IN id_presupuesto INT,
                                                        id_tecnico INT,
                                                        id_prestacion INT,
                                                        importePrestacion DECIMAL(9,2),
                                                        observaciones TEXT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertAcceso`(IN id_usuario INT,
                                                        id_menu INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertAjusteStock`(IN id_zona INT,
                                                fecha DATE,
                                                id_empresa INT,
                                                usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertAjusteStockDetalle`(id_producto INT,
                                                            cantidad INT,
                                                            dc VARCHAR(1),
                                                            lote VARCHAR(45),
                                                            pm VARCHAR(45),
...
INSERT INTO stockdetalle (id_ajusteStock, id_producto, cantidad, dc, lote,
                            pm, vencimiento, costoPesos, id_moneda, cotizacion, 
                            observaciones, id_zona)
VALUES (id, id_producto, cantidad, dc, lote,
        pm, vencimiento, costoPesos, id_moneda, cotizacion, 
        observaciones, id_zona);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertCaja`(IN id_caja INT,
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertCajaAsignada`(IN id_presupuesto INT,
                                                            id_cajaDeposito INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertCajaComposicion`(IN id_cajaDeposito INT,
                                                                id_producto INT,
                                                                cantidad INT,
                                                                usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertCajaDeposito`(IN id_cajaDeposito INT,
                                                        id_zona INT,
                                                        id_caja INT,
                                                        codigo VARCHAR(25),
                                                        habilita VARCHAR(1),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertClasiEntidad`(IN id_clasiEntidad INT,
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertClasiProducto`(IN id_clasiProducto INT,
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertCodConsumo`(IN id_codConsumo INT,
                                                    codigo VARCHAR(10),
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertCotizacion`(IN id_moneda INT,
										mes INT,
                                        año INT,
                                        valor DECIMAL(12,3),
                                        id_empresa INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertDiaria`(IN id_diaria INT,
                                                        nombre VARCHAR(100),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertEntidad`(IN id_entidad INT,
                                                        nombre VARCHAR(100),
                                                        direccion VARCHAR(100),
                                                        id_provincia INT,
                                                        id_departamento INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertEspecialidad`(IN id_especialidad INT,
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertEstrategia`(IN id_estrategia INT,
                                                        id_profesional INT,
                                                        fechaInicio DATE,
                                                        fechaAgenda DATE,
                                                        perfil TEXT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertEstrategiaEntidad`(IN id_estrategiaEntidad INT,
                                                        id_entidad INT,
                                                        fechaInicio DATE,
                                                        fechaAgenda DATE,
                                                        requisitos TEXT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertFactura`(IN fecha DATE,
                                                        id_presupuesto INT,
                                                        id_tipoComp INT,
                                                        numComp VARCHAR(12),
                                                        id_tipoCompRel INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertForecast`(IN anio INT,
										id_vendedor INT,
                                        id_entidad INT,
                                        id_productoFact INT,
                                        cantidad INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertForecastComposicionGrupo`(IN id_forecastGrupo INT,
														id_productoFact INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertForecastEntidad`(IN id_entidad INT,
											id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertForecastGrupo`(IN id_forecastGrupo INT, 
											nombre VARCHAR(45),
                                            habilita VARCHAR(1),
                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertFormaPago`(IN id_formapago INT,
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertIntersucursal`(IN usuario VARCHAR(45),
																		id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertIntersucursalCaja`(IN id_cajaDeposito INT,
																		devuelto VARCHAR(1))
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertLiquidacion`(IN fecha DATE,
                                                            observaciones TEXT,
                                                            id_empresa INT,
                                                            usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertLiquidacionDetalle`(IN id_liquidacion INT,
                                                                    banco VARCHAR(45),
                                                                    cheque VARCHAR(45),
                                                                    vencimiento DATE,
                                                                    importe DECIMAL(7,2),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertMantenimiento`(IN id_mantenimiento INT,
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertMayorProfesional`(IN fecha DATE,
                                                    id_presupuesto INT,
                                                    id_profesional INT,
                                                    dc VARCHAR(1),
                                                    importe DECIMAL(9,2),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertMayorTecnico`(IN fecha DATE,
                                                            id_presupuesto INT,
                                                            id_tecnico INT,
                                                            dc VARCHAR(1),
                                                            importe DECIMAL(7,2),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertMoneda`(IN id_moneda INT,
                                                        codigo VARCHAR(3),
                                                        nombre VARCHAR(45),
                                                        simbolo VARCHAR(3),
                                                        habilita VARCHAR(1),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertNivelesCertificado`(IN id_nivelesCertificado INT,
																	id_presupuesto INT,
                                                                    alternativas INT,
                                                                    instrumental INT,
                                                                    asistencia INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertNotaPresu`(IN nota TEXT,
                                                        id_empresa INT,
                                                        usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertPadre`(IN id_usuario INT,
                                                        id_empresa INT,
                                                        posicion VARCHAR(30))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertPlazo`(IN id_plazo INT,
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertPreliquidacion`(IN fecha DATE,
                                                                id_presupuesto INT,
                                                                id_profesional INT,
                                                                dc VARCHAR(1),
                                                                importe DECIMAL(9,2),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertPrestacion`(IN id_prestacion INT,
                                                        nombre VARCHAR(45),
                                                        importe DECIMAL(9,2),
                                                        habilita VARCHAR(1),
                                                        id_empresa INT)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertPresupuesto`(IN id_presupuesto INT,
                                                        estado VARCHAR(1),
                                                        fecha DATE,
                                                        id_zona INT,
                                                        id_entidad INT,
...
IF id_presupuesto NOT IN (SELECT presupuesto.id_presupuesto FROM presupuesto) then
	INSERT INTO presupuesto (id_presupuesto, estado,fecha,id_zona,id_entidad,id_lugarCirugia,
                            ...
                            usuario, fechaAprobacion, notaExtra)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertPresupuestoProd`(IN id_empresa INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertProducto`(IN id_producto INT,
                                                        codigo VARCHAR(25),
                                                        nombre VARCHAR(255),
                                                        id_codConsumo INT,
                                                        id_moneda INT,
...
IF (id_producto = 0) THEN
    ...
    INSERT INTO producto (codigo, nombre, id_codConsumo, id_moneda, costo,
                            stockMinimo, id_clasiProducto, pm, id_proveedor, habilita,
                            id_empresa)
                            
                VALUES (codigo, nombre, id_codConsumo, id_moneda, costo,
                            stockMinimo, id_clasiProducto, pm, id_proveedor, habilita,
                            id_empresa);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertProductoFact`(IN id_productoFact INT,
                                                    codigo VARCHAR(10),
                                                    nombre VARCHAR(45),
                                                    id_especialidad INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertProfesional`(IN id_profesional INT,
                                                        nombre VARCHAR(45),
                                                        direccion TEXT,
                                                        id_provincia INT,
                                                        id_departamento INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertProveedor`(IN id_proveedor INT,
                                                        nombre VARCHAR(45),
                                                        direccion VARCHAR(100),
                                                        id_localidad INT,
                                                        id_departamento INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertRemito`(IN id_remito INT,
                                                    id_presupuesto INT,
                                                    fecha DATE,
                                                    id_tipoComp INT,
                                                    numComp VARCHAR(12),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertRemitoDetalle`(IN id_remito INT,
                                                            id_producto INT,
                                                            cantidad INT,
                                                            dc VARCHAR(1),
                                                            lote VARCHAR(45),
...
INSERT INTO stockdetalle (id_remito, id_producto, cantidad, dc, lote,
                            pm, vencimiento, costoPesos, id_moneda, cotizacion, 
                            observaciones, id_zona)
                            
VALUES (id_remito, id_producto, cantidad, dc, lote,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertRevisionSoftware`(IN detalleRevision TEXT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertStock`(IN id_stock INT,
                                                    fecha DATE,
                                                    id_tipoComp INT,
                                                    numComp VARCHAR(12),
                                                    id_proveedor INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertStockDetalle`(IN id_stock INT,
                                                            id_producto INT,
                                                            cantidad INT,
                                                            dc VARCHAR(1),
                                                            lote VARCHAR(45),
...
INSERT INTO stockdetalle (id_stock, id_producto, cantidad, dc, lote,
                            pm, vencimiento, costoPesos, id_moneda, cotizacion, 
                            observaciones, id_zona)
VALUES (id, id_producto, cantidad, dc, lote,
        pm, vencimiento, costoPesos, id_moneda, cotizacion, 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertSubespecialidad`(IN id_subespecialidad INT,
                                                        id_especialidad INT,
                                                        nombre VARCHAR(45),
                                                        habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertTecnico`(IN id_tecnico INT,
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1),
                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertUsuario`(IN id_usuario INT,
                                                        nombre VARCHAR(45),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertVendedor`(IN id_vendedor INT,
                                                        nombre VARCHAR(45),
                                                        id_zona INT,
                                                        id_especialidad INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertZona`(IN id_zona INT,
                                                    nombre VARCHAR(45),
                                                    habilita VARCHAR(1))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `liquidaMayorProfesional`(IN id_mayorProfesional INT,
                                                                id_liquidacion INT,
                                                                id_empresa INT,
                                                                usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `liquidaMayorTecnico`(IN id_mayorTecnico INT,
                                                                usuario VARCHAR(45),
                                                                id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `listaPresupuesto`(IN id_empresa INT(11), meses INT(2))
BEGIN
SELECT id_presupuesto, DATE_FORMAT(fecha,'%d/%m/%Y') AS fecha, IFNULL(entidad.nombre,'') as entidad, IFNULL(lugar.nombre,'') as lugar,
    IFNULL(profesional.nombre,'') as profesional, paciente, presupuesto.dni as dni, presupuesto.total, ifnull(zona.nombre, '') as zona,
    IFNULL(tipooperacion.nombre, '') as tipoOperacion,
    IF(presupuesto.estado = 'P', 'PENDIENTE', IF(presupuesto.estado = 'A', 'APROBADO', IF(presupuesto.estado = 'C', 'CONFIRMADO', 
		IF(presupuesto.estado = 'Z', 'FINALIZADO', IF(presupuesto.estado = 'N', 'ANULADO', 'RECHAZADO'))))) as estado
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `logSistema`(IN usuario VARCHAR(45),
															equipo VARCHAR(255),
															log TEXT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `mapaConfirmaTurno`(IN id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `modificaRemitoConsumido`(IN id_remito INT,
                                                        observaciones TEXT,
                                                        usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `nuevoInicial`(IN id_empresa INT,
                                                                                ids TEXT,
                                                                                desde DATE,
                                                                                hasta DATE,
                                                                                lote VARCHAR(45),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `nuevoPresu`(IN id_presupuesto INT,
									id_zona INT,
									usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `productosForecast`(IN anio INT,
																id_vendedor INT,
                                                                id_forecastGrupo INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `recibeIntersucursal`(IN id_remito INT,
											observaciones TEXT,
											usuario VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `recibeRemito`(IN id_remito INT,
															usuario VARCHAR(45),
                                                            equipo VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `selectEntidad`(IN id_empresa INT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `selectLocalidad`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `selectProfesional`(id_empresa INT,
                                                        soloHabilitados BOOLEAN)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `selectSubespecialidad`(IN soloHabilitados BOOLEAN)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `selectVendedor`(IN id_empresa INT,
                                            soloHabilitados BOOLEAN)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `stockCajas`(IN id_zona INT,
															id_caja INT,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `stockSaldoInicial`(IN id_zona INT,
                                                            id_producto INT,
                                                            desde DATE,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `suspendeAnulaPresupuesto`(IN id_presupuesto INT,
												estado VARCHAR(1),
                                                id_motivo INT,
                                                motivo TEXT,
                                                usuario VARCHAR(45),
...
CASE estado
    ...
    WHEN 'A' THEN SET accion = 'Suspende';
END CASE;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `traeAccesos`(IN id_usuario INT,
                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeAltaStock`(IN id_stock INT, 
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeCajaZona`(IN id_zona INT,
                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeEntidad`(IN id_entidad INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeLiquidacionTecnico`(IN nroLiquidacion INT,
                                                                id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `traePagosLiquidacion`(IN id_liquidacion INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `traePorcentaje`(IN id_grupoPorcentaje INT,
                                                        id_especialidad INT,
                                                        id_zona INT,
                                                        id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traePresupuesto`(IN id_presupuesto INT(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traePresupuestoProd`(IN id_presupuesto INT(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeProductoCodigo`(IN codigo VARCHAR(15),
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeProductoId`(IN id_producto INT,
                                                            id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeProfesional`(IN id_profesional INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeRemito`(IN id_remito INT,
                                                    numComp VARCHAR(12),
                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `traeRemitoCaja`(IN id_remito INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeRemitoDetalle`(IN id_remito INT)
BEGIN

SELECT stockdetalle.cantidad, producto.codigo as codigo, producto.nombre as nombre, stockdetalle.costoPesos,
    stockdetalle.id_producto, stockdetalle.lote, stockdetalle.pm, IFNULL(DATE_FORMAT(stockdetalle.vencimiento, '%d/%m/%Y'), '') as vencimiento,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeRmPresupuesto`(IN id_presupuesto INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `traeRubros`(IN id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeStockDetalle`(IN id_stock INT)
BEGIN

SELECT stockdetalle.id_producto, producto.codigo as codigo, producto.nombre as nombre,
        stockdetalle.cantidad, stockdetalle.lote, stockdetalle.pm, stockdetalle.vencimiento,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `traeTurno`(IN id_presupuesto INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `traeTurnosLiquidacion`(IN id_liquidacion INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateComparativa`(IN id_presupuesto INT,
                                                        competencia TEXT,
                                                        lobby TEXT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `updateObservacionesPresupuesto`(IN id_presupuesto INT,
													observaciones TEXT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `updateObservacionesStock`(IN id_stock INT,
													observaciones TEXT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `updatePresupuesto`(IN estado VARchar(1),
                                                        in fecha date,
                                                        in id_zona int(11),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `updateRemitoDetalle`(IN id_remito INT,
											id_producto INT,
											lote VARCHAR(45),
                                            pm VARCHAR(45),
                                            vencimiento DATE)
...
WHERE stockdetalle.id_remito = id_remito AND
		stockdetalle.id_producto = id_producto;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usuarioAdministrador`(IN id_usuario INT, 
                                                    id_empresa INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `zonaSistema`(IN id_usuario INT,
									id_zonaSistema int)
BEGIN
...
-- Dump completed on 2015-10-25 20:07:59
